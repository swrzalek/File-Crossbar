...
**W5.** Jako użytkownik systemu FileCrossbar [kto] w zakładce "Odbierz zdjęcie" [gdzie] mam możliwość przejścia do zakładki "Załaduj zdjęcie"[co].

**W6.** Jako użytkownik systemu FileCrossbar [kto] w zakładce "Załaduj zdjęcie" [gdzie] mam możliwość przejścia do zakładki "Odbierz zdjęcie"[co].

**W7.** Jako osoba udostępniająca zasób [kto] po udostępnieniu pliku w aplikacji "Załąduj zdjęcie" [gdzie] mam możliwość udostępnienia nastepnego zasobu [co].
#### 1.2.2 Wymagania Niefunkcjonalne

**W8.** Jako użytkownik systemu FileCrossbar, [kto] chcę aby moje pliki zostały usunięte z serwera po upływie 24 godzin[co] w celu zapewnienia bezpieczeństwa [dlaczego].

**W9.** Jako użytkownik systemu FileCrossbar, [kto] chcę aby kod dostępu do pliku został zaszyfrowany [co] aby zapobiegać kradzieży danych [dlaczego].

**W10**. Użytkownik aplikacji FileCrossbar [kto] we wszystkich zakładkach aplikacji [gdzie] sprawnie ładuję dane(do 1s)[co].
...
#### Odpowiedź systemu:  
1. Poprawne wysłanie zdjęcia.
2. Otrzymanie wygenerowanego kodu.

### 3.3. T3 - Odebranie zdjęcia 
**Scenariusz dotyczy:** W3
**Cel testu:**  Testowanie odbioru udostępnionego zdjęcia.
**Sposób dostępu:** Widok wywoływany poprzez wybranie z menu "RECEIVE". 
**Scenariusz (kroki testowe):**   
#### Akcje użytkownika:  
...
### 3.5. T5 - Przejście miedzy widokami - RECEIVE -> SEND
**Scenariusz dotyczy:** W5  
**Cel testu:** Testowanie nawigacji w aplikacji.
**Sposób dostępu:** Widok wywoływany poprzez kliknięcie w menu "RECEIVE".
**Scenariusz (kroki testowe):**   
#### Akcje użytkownika:  
1. Wybranie przycisku z lewej strony
#### Odpowiedź systemu:  
1. Przekierowanie na widok "SEND"

### 3.6. T6 - Przejście miedzy widokami - SEND -> RECEIVE
**Scenariusz dotyczy:** W6  
**Cel testu:** Testowanie nawigacji w aplikacji.
**Sposób dostępu:** Widok wywoływany poprzez kliknięcie w menu "SEND".
**Scenariusz (kroki testowe):**   
#### Akcje użytkownika:  
1. Wybranie przycisku z prawej strony
#### Odpowiedź systemu:  
1. Przekierowanie na widok "RECEIVE"

### 3.7. T7 - Udostępnienie kilku zdjęć
**Scenariusz dotyczy:** W7  
**Cel testu:** Testowanie udostępnienia kliku zdjęć.
**Sposób dostępu:** Widok wywoływany poprzez kliknięcie w menu "SEND".
**Scenariusz (kroki testowe):**   
#### Akcje użytkownika:  
1. Wybranie przycisku "CHOOSE FILES".
2. Wybranie zdjęcia.
3. Wybranie przycisku "CHOOSE NEXT
4. Powtórzenie akcji 1 i 2 
#### Odpowiedź systemu:  
1. Poprawne wysłanie zdjęć
2. Otrzymanie wygenerowanych kodów.


### 3.8. T8 - Udostępnionie zdjęcia - bezpieczeństwo
...
### 3.9. T9 - Odebranie kodu zdjęcia - bezpieczeństwo
**Scenariusz dotyczy:** W9  
...
### 3.10. T10 - Pomiar szykbości aplikacji
**Scenariusz dotyczy:** W10  
